...
class handlers():
    ...
    def setupHandlers(obj):
        ...
        obj.pushButtonAbrirArquivo.clicked.connect(lambda: handlers.SelecionarImagem(obj))
...
"color: rgb(255, 255, 255);")
        ...
        self.comboBoxAlgoritmo.addItem("")
        self.comboBoxAlgoritmo.addItem("")
        self.pushButtonAbrirArquivo = QtWidgets.QPushButton(self.frame_botoes)
        self.pushButtonAbrirArquivo.setGeometry(QtCore.QRect(30, 196, 131, 26))
        self.pushButtonAbrirArquivo.setStyleSheet("QPushButton{\n"
"background-color: rgb(27, 27, 27);\n"
"font: 12pt \"Verdana\";\n"
"color: rgb(255, 255, 255);\n"
"}\n"
...
"}\n"
"")
        self.pushButtonAbrirArquivo.setObjectName("pushButtonAbrirArquivo")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonAbrirArquivo.setText(_translate("MainWindow", "abrir arquivo"))
